        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <p class="text-center ">
                        Basierend auf der von Ihnen gewählten Renditenverteilung sollten Sie im Rahmen einer Altersvorsorge
                       <b><?php echo $_SESSION['output'];?></b> % Ihrer Ersparnisse in Aktienfonds und
                        <b><?php echo (100-$_SESSION['output']);?></b> % in ein Sparkonto investieren.
                    </p>
                    <hr>
                </div>

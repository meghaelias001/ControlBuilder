                            ...
                            <div class="collapse navbar-collapse" id="main_nav">
                                <ul class="nav navbar-nav">
                                   ...
                                   <!-- <li class="dropdown main_menu">
                                        <a href="#" class="dropdown-toggle drop_menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Mehr Seiten</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="abschlussfragebogen-5.php">Abschlussfragebogen V</a></li>
                                            <li><a href="abschlussfragebogen-6.php">Abschlussfragebogen VI</a></li>
                                            <li><a href="abschlussfragebogen-7.php">Abschlussfragebogen VII</a></li>
                                            <li><a href="abschlussfragebogen-8.php">Abschlussfragebogen VIII</a></li>
                                            <li><a href="abschlussfragebogen-9.php">Abschlussfragebogen IX</a></li>
                                        </ul>
                                    </li> -->
                                </ul>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <p class="text-center ">
                            ...
                            <?php echo $_SESSION['output'];?> % Ihrer Ersparnisse in Aktienfonds und
                            <?php echo (100-$_SESSION['output']);?> % in ein Sparkonto.
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <form id="submitform" action="abfrage1New_proc.php" method="POST">
                            <div class="form-row">
                                <div class="clearfix">
                            ...
                            <div class="form-row">
                               ...
                               <div class="clearfix">
								    ...
								    <div class="clearfix">
                                        ...
                                        <div class="row pb15">
                                            <div class="col-md-6 col-xs-6 text-left wrd-brk">Sehr schlecht</div>
                                            <div class="col-md-3 col-xs-3 text-right wrd-brk">Sehr gut</div>
                                        </div>

                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="nav navbar-nav">
                            <li class="main_menu active">
                                <a href="definitions.html" class="dropdown-toggle drop_menu">Definitionen</a>
                            </li>
                            <li class="dropdown main_menu">
    ...
    <h3 style="font-family:Georgia;" align='center'>Sorry..!!</h3>
    </div>
    </div>
    </div>
    	   </section>
                                             <section id="feedbackScreen">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">  
         <p align="center" style="font-size:15px;""> You already tried this ..!!
     </p>            
           </div>
       </div>
    </div>
